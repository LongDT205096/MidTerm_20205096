...
--task 4
--create index "count" on orderlines(prod_id)
...
--task 5
--create index list on customers(customerid)
--select ord.customerid, concat(firstname,' ', lastname) as fullname 
--from customers cus
--inner join orders ord on cus.customerid = ord.customerid

--task 6
--select cus.customerid, concat(firstname,' ', lastname) as fullname 
--from customers cus
